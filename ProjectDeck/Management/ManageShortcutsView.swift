...
public struct ManageShortcutsView: View {
                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        VStack(spacing: 16) {
                            // Drop Zone
                            FolderDropZoneView(
                                onFoldersDropped: { urls in
                                    handleFoldersAddition(urls: urls, to: proj)
                                },
                                onBrowseClicked: {
                                    showOpenPanel()
                                }
    ...
    private func handleFoldersAddition(urls: [URL], to project: Project) {
    ...
    private func showOpenPanel() {
        ...
        openPanel.title = "Select Project Folders"
        ...
        if openPanel.runModal() == .OK, let proj = selectedProject {
            handleFoldersAddition(urls: openPanel.urls, to: proj)
        }
    }
}
